...
Aligned with national standard management objectives

1.  Achieve OY while preventing overfishing: catch limits, effort controls, size and gear restrictions, bycatch reduction, habitat protection
1.  Best available science basis: SSC decides (can indicators reduce uncertainty?)
1.  Unit stock management: (spatial management and consideration of range shifts?)
1.  Fair equitable allocations: FMP amendments? (some use distribution information)
1.  Efficient use of resource: permits?
1.  Consider variation and contingency: NEPA analyses? (seems like this requires indicators and projections)
1.  Minimize cost and duplication
1.  Consider communities and avoid adverse impacts: NEPA analyses? (community vulnerability assessment)
1.  Minimize bycatch and mortality: fishing gear restrictions, open/closed seasons, open/closed areas 
1.  Safety at sea
...
*  Ecosystem information is being used operationally to support decisions in multiple processes
    ...
    +  Potentially to use indicators in more decisions
...
.pull-right[
## Mid Atlantic Risks Identified in 2025
