...
# Management objectives aligned with example decisions
...
1.  Licensing and permitting, Reporting requirements, Limited access
...
.pull-left[
**Objective:** I want to see the Aurora Borealis from my backyard.

**Context:** I live on Cape Cod in Massachusetts and this is an unusual event here. The best views are when I am asleep (10 pm - 2 am).

**Decision:** Should I wake up and get out of bed to go outside and look at the sky? 

**Option:** Stay up every night between 10 pm and 2 am and look the whole time.  

**Likely outcome:** Every day my sleep is interrupted and I never see the Aurora.
]

.pull-right[
![Bourne Bridge photo Nov 11 2025](https://github.com/sgaichas/HSpresentations/raw/main/docs/images/FB_BourneAurora.jpg)
Bourne Bridge, Cape Cod, MA, 11 November 2025
]
...
## A toy example with indicators

**Decision, framed around a SMART objective:** 

When (date and time) should I wake up and get out of bed to go outside and look at the sky to have the best chance of seeing the Aurora in my backyard?

**Risk policy:** What probability of seeing the Aurora makes it worth waking up and getting out of bed?

**Potential supporting information (issues):** 
*  Friends' photos posted on social media (lagging indicator for infrequent social media users or people who sleep--but this could work for night owls who are always plugged in)
*  [Newspaper articles](https://www.nytimes.com/2025/11/12/science/space/northern-lights-photos-geomagnetic-storm.html) (lagging indicator, imprecise for my location)
...
.pull-right[
*  [NOAA Space Predictions](https://www.swpc.noaa.gov/communities/aurora-dashboard-experimental) (forecast! enough?)  
.center[
![:img NOAA forecast, 70%](https://github.com/sgaichas/HSpresentations/raw/main/docs/images/NOAAspaceforecast.png)
]  
*  Other things I need to know ([via AuroraReach](https://aurorareach.com/guide))
![Factors affecting Aurora view](https://github.com/sgaichas/HSpresentations/raw/main/docs/images/AuroraForecastFactors.png)
]

---
# Objective, Decision, and Information Needs Aligned

*  [AuroraReach Indicator Dashboard](https://aurorareach.com/map#google_vignette) (multi-indicator forecast for my location with notification threshold)
*  Validation: does it work?

.pull-left[
![Bourne Predition AuroraReach](https://github.com/sgaichas/HSpresentations/raw/main/docs/images/AuroraForecastBourneNov112025.png)
[AuroraReach prediction for Bourne, MA](https://aurorareach.com/sightings/2025/11/11/6a3e4f1662a14ebca7ac1555defc67d8)
]
...
## What information would be helpful, by decision? Examples

**Catch limits:** environmentally driven changes in productivity and availability

**Allocation:** changes in distribution, spatial changes in productivity and availability,  community vulnerability  

**Efficient use:** changes in distribution of fish and fisheries, spatial and seasonal changes in productivity and availability
