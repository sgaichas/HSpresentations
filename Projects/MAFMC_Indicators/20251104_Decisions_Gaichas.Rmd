...
## Routine/Tactical: can be modified through specifications across many FMPs
...
## Routine/Tactical: can be modified by SSC

*  Best scientific information determination (also involves scientific working group and review panel judgement)

???
Note that commercial minimum mesh sizes are often associated with an incidental possession limit. E.g., any vessel possessing more than 5,000 lb of butterfish must use codend mesh that’s at least 3 inches diamond or square.

“Modification of existing accountability measures and ACT control rules utilized by the Monitoring Committee” is also on the specs list for several FMPs but I don’t think we should include it as an example. I think the nuances will be confusing. Changes to how AMs are structured should require a framework or amendment.

Research Set Aside - changeable by framework though it’s not an active program right now!

---
# Initial list of management decisions

## Occasional and or Strategic; can be modified through a framework adjustment
